...
namespace Blog.API.Utils
{
    public class CalcData
    {
        ...
        public static async Task<List<DayData>> GetFuQuanData(BlogContext db, string stockId, int lastedNum)
        {
        ...
        public static async Task FuQuan(BlogContext db, string stockId, List<DayData> list)
        {
            if (list.Count > 0)
            {
