...
namespace Blog.API.ViewModels.Fillers
{
    public class F10FHPGFillerViewModel : BaseDoWorkViewModel
    {
        ...
        public F10FHPGFillerViewModel(IServiceScopeFactory serviceScopeFactory,
            ...
            ILogger<F10FHPGFillerViewModel> logger) : base(serviceScopeFactory)
        {
            _logger = logger;
            this.stockHandle = F10FHPGFiller_stockHandle;

        }


        async Task F10FHPGFiller_stockHandle(BaseDoWorkViewModel.StockArgs e)
        {
