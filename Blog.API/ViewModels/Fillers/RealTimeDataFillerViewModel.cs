...
{
    public class RealTimeDataFillerViewModel : BaseDoWorkViewModel
    {


        private readonly ILogger _logger;
        public RealTimeDataFillerViewModel(IServiceScopeFactory serviceScopeFactory,

            ILogger<RealTimeDataFillerViewModel> logger) : base(serviceScopeFactory)
        {
            _logger = logger;
